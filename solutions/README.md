...
GitHub Copilot CLI版の3方式は、2026年8月1日にGitHub Copilot CLI 1.0.77とAutoが選択したGPT-5.6 Terra（Medium）で作成しました。実行条件、権限境界、追加指示、ブラウザ確認、比較結果は`experiments/copilot-cli/2026-08-01/`に記録しています。
